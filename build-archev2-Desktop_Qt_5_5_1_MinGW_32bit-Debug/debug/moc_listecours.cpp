...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ListeCours_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(7, 60, 14) // "desinscription"

    },
    "ListeCours\0askDisplayFen\0\0fenInd\0"
    "handleButton\0inscription\0s\0desinscription"
};
...
void ListeCours::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->desinscription((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
...
void *ListeCours::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ListeCours.stringdata0))
